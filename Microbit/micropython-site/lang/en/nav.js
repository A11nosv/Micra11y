const PAGES=[
  {id:'index',file:"index.html",num:'',title:'Home',icon:'🏠'},
  {id:'dua',file:"dua.html",num:'00',title:'UDL in this manual',icon:'♿'},
  {id:'cap1',file:"cap1.html",num:'01',title:'Setting up',icon:'🖥️'},
  {id:'cap2',file:"cap2.html",num:'02',title:'Variables & data types',icon:'📦'},
  {id:'cap3',file:"cap3.html",num:'03',title:'Conditionals',icon:'🚦'},
  {id:'cap4',file:"cap4.html",num:'04',title:'Loops',icon:'🔄'},
  {id:'cap5',file:"cap5.html",num:'05',title:'Lists & functions',icon:'🧩'},
  {id:'cap6',file:"cap6.html",num:'06',title:'Sensors',icon:'🌡️'},
  {id:'cap7',file:"cap7.html",num:'07',title:'Sound & music',icon:'🎵'},
  {id:'cap8',file:"cap8.html",num:'08',title:'Radio communication',icon:'📡'},
  {id:'cap9',file:"cap9.html",num:'09',title:'Complete projects',icon:'🚀'},
  {id:'cap10',file:"cap10.html",num:'10',title:'Pedagogical Guide',icon:'🎓'},
  {id:'cap11',file:"cap11.html",num:'11',title:'Accessibility and Design',icon:'♿'},
  {id:'apendice',file:"apendice.html",num:'A',title:'Quick Reference',icon:'📋'},
  ];
  const SECS=[
  {title:'General',ids:['index','dua']},
  {title:'Chapters',ids:['cap1','cap2','cap3','cap4','cap5','cap6','cap7','cap8']},
  {title:'Projects and Guide',ids:['cap9','cap10','cap11']},
  {title:'Reference',ids:['apendice']},
  ];
function buildSidebar(a){
  let h=`<div class="sidebar-logo"><div class="logo-mark">micro<span style='color:var(--coral)'>Python</span><br>in the Classroom</div><div class="logo-sub">Manual with UDL approach</div></div><nav>`;
...
function buildPageNav(a){
  ...
  if(pv)h+=`<a href="${pv.file}"><span>←</span><div><span class="nav-label">Previous</span><span class="nav-title">${pv.icon} ${pv.title}</span></div></a>`;
  else h+=`<span></span>`;
  if(nx)h+=`<a href="${nx.file}" class="nav-next"><div><span class="nav-label">Next</span><span class="nav-title">${nx.icon} ${nx.title}</span></div><span>→</span></a>`;
  h+='</div>';return h;
}
function initPage(a){
...
function duaBox(type,items){
  const cfg={rep:{cls:'dua-rep-group',icon:'🟥',label:'UDL — Representation'},ace:{cls:'dua-ace-group',icon:'🟦',label:'UDL — Action & Expression'},imp:{cls:'dua-imp-group',icon:'🟩',label:'UDL — Engagement'}}[type];
...
function noteBox(i){return box('note','📝','Note for the teacher',i);}
function tipBox(i){return box('tip','💡','Teaching tip',i);}
function warnBox(i){return box('warn','⚠️','Warning',i);}
function conceptBox(i){return box('concept','🔑','Key concept',i);}
...
const LVL=['', '🟢 Starter (6-8)', '🟡 Basic (9-11)', '🟠 Intermediate (12-13)', '🔴 Advanced (14-16)'];
